...
public class NegativeOperator extends UnaryOperator implements SignOperator {
    public NegativeOperator(int pos, int length, Token prev) {
    ...
    public Value evaluate(EvaluateStrategy strategy, Value value) {
        return strategy.toNegative(value);
    }
}
